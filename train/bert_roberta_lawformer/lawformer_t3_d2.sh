...
export WANDB_PROJECT="LJP_baselines_task3"
export WANDB_USERNAME="loss4wang"
export WANDB_API_KEY="81a3c9c3fa59f92cbf80af38f03905c8ea01a3fc"
export WANDB_NAME="lawformer_data2_t3_bs32_lr5e-5" #! need change every run
...
$python_exec "$script_path" \
    ...
    --train_file "/local/xiaowang/LJP Task/Data/Datasets/train_data2.csv" \
    --validation_file "/local/xiaowang/LJP Task/Data/Datasets/val_data2.csv" \
    --test_file "/local/xiaowang/LJP Task/Data/Datasets/test_data2.csv" \
    --is_single_classification "False"\
    --label_column_name "imprisonment" \
    ...
    --do_eval "True" \
    --do_predict "True" \
    --output_dir "/local/xiaowang/LJP Task/baseline_output/Task3/Data2/lawformer_lr5" \
